...
type MonitoringClient interface {
	IsAlive(ctx context.Context, in *IsAliveRequest, opts ...grpc.CallOption) (*IsAliveResponce, error)
}
...
func (c *monitoringClient) IsAlive(ctx context.Context, in *IsAliveRequest, opts ...grpc.CallOption) (*IsAliveResponce, error) {
	out := new(IsAliveResponce)
	err := c.cc.Invoke(ctx, "/common.Monitoring/IsAlive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MonitoringServer interface {
	IsAlive(context.Context, *IsAliveRequest) (*IsAliveResponce, error)
}
...
func (UnimplementedMonitoringServer) IsAlive(context.Context, *IsAliveRequest) (*IsAliveResponce, error) {
...
func _Monitoring_IsAlive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IsAliveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MonitoringServer).IsAlive(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/common.Monitoring/IsAlive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MonitoringServer).IsAlive(ctx, req.(*IsAliveRequest))
	}
...
var Monitoring_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "common.Monitoring",
	HandlerType: (*MonitoringServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "IsAlive",
			Handler:    _Monitoring_IsAlive_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "isalive.proto",
}
